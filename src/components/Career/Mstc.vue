  ...
  <div>
    ...
    <fieldset>
      ...
      <ul>
        ...
        <p class="career_p">
          (주)엠에스티씨는 현대모비스 연구개발본부의 협력사로서 자동차 AVN, AUDIO 소프트웨어 검증 및 평가, 개발 지원을 주 사업으로 하고있습니다.
          AVN시스템 소프트웨어의 안정성과 신뢰성 확보를 위한 소프트웨어 검증뿐만 아니라 차종 개발 소프트웨어 설계를 동시에 수행할 수 있는 우수한 경쟁력을 확보하고 있는 기업입니다.
        </p>
        <li>
          Software
        </li>
        <p class="career_p">
          차종 개발 소프트웨어 설계와 AVN시스팀 검증/평가를 통해 높은 품질과 완성도 높은 차량 생산에 일조하고 있습니다. IT 및 소프트웨어 전장 장비 확대로 실시간 네비게이션, 원격 차량 제어 및 관리뿐만 아니라 미디어 스트리밍의 영역까지 다루고 있습니다.
        </p>
        <li>Testing</li>
        <p class="career_p">
          ...
          출시, 정책 변경 등 외부 플랫폼 변경 사항 대응- 이슈 대응 및 관리
        </p>
      </ul>
    </fieldset>
    <br /><br />
