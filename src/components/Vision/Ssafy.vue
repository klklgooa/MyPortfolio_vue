  ...
  <div>
    ...
    <fieldset>
      ...
      <ul>
        ...
        <li>
          고용노동부의 취업지원 노하우를 기반으로 교육생에게 최적의 일자리 정보를 제공
        </li>
      </ul>
    </fieldset>
  </div>
...
<script>
import ssafy1 from "../../image/ssafy1.png"; // 이미지 경로 수정
import ssafy2 from "../../image/ssafy2.png"; // 이미지 경로 수정
import ssafy3 from "../../image/ssafy3.png"; // 이미지 경로 수정
